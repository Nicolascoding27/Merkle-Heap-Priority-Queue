...
describe('Merkle Heap', () => {
  ...
  //If the heap was initialized successfully so it is empty the root should correspond to the hash of the child nodes which are Field(0) and its hashes.
  ...
  describe('Delete Min function test', () => {
    it('Verifies that the min number is being deleted', async () => {
      try {
        ...
        //To verify that the value is no anymore in the queue I use the in-queue function
  ...
  describe('Delete Element at index function test', () => {
    it('Should delete the element in a specific index', async () => {
      try {
        //In the case of a Min Heap, the least value is the root or father
